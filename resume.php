...
<head>
    <meta charset="utf-8" />
    <title>Isaias Cristiano Ceccatto</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Isaias Cristiano Ceccatto" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Isaias Cristiano Ceccatto" />
    <!-- Styles -->
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/p_20180108_153814.jpeg"
                            alt="Isaias Cristiano Ceccatto">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Isaias Cristiano Ceccatto</h4>
                        <div class="status">Aluno do curso Desenvolvedor WEB</div>
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/isaias.ceccatto/">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/ISAIAS30">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/isaias.ceccatto">
                                    <i class="font-icon icon-youtube"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/Isaias">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Ensino Medio-E. E. E. Basíca
                                            Luiza Formighieri

                                        </h5>
                                        <span class="timeline__period">2015 — 2017</span>
                                        <p class="timeline__description">
                                            E. E. E. Basíca Luiza Formighieri</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Bacharelado em Eng. Controle e
                                            Automação
                                        </h5>
                                        <span class="timeline__period">2018 — até o momento</span>
                                        <p class="timeline__description">IFC - Luzerna</p>
                                    </article>
                            ...
                            <div class="col-12">
                                <h2 class="title title--h3"><img class="title-icon"
                                        src="assets/icons/dark/icon-experience.svg" alt="" /> Experiência</h2>
                                <div class="timeline">
                                    <!-- Item -->
                                    <article class="timeline__item">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Isaias Cristiano Ceccatto</footer>
                </div>
            </div>
        </div>
    </main>
